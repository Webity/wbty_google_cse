...
// Access check.
if (!JFactory::getUser()->authorise('core.manage', 'com_wbty_google_cse')) {
...
JHTML::stylesheet('wbty_google_cse/wbty_google_cse.css', false, true);
...
$controller	= JControllerLegacy::getInstance('Wbty_google_cse');
